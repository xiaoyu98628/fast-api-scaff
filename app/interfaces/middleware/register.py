...
from app.interfaces.middleware.exception_capture import (
    ExceptionCaptureMiddleware,
    register_exception_capture,
)
...
def register_middleware(app: FastAPI) -> None:
    ...
    # 统一异常出口（最后注册）：中间件 + 路由内校验异常，同一入口见 register_exception_capture。
    register_exception_capture(app)
