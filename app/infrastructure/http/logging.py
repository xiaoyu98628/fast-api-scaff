...
class HttpLogEvent(StrEnum):
    ...
    POOL_ORPHAN_DISCARDED = "http.outbound.pool.orphan_discarded"
    POOL_ORPHAN_DISCARD_FAILED = "http.outbound.pool.orphan_discard_failed"
    POOL_ORPHAN_CLOSE_FAILED = "http.outbound.pool.orphan_close_failed"
    POOL_COMPATIBILITY_FAILED = "http.outbound.pool.compatibility_failed"
