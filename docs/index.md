...
建议先按顺序阅读“开始使用”，遇到具体问题时再进入专题章节。文档只描述当前代码中已经实现并可验证的能力。
...
- [独立 Scheduler](scheduler.md)：代码计划、Cron/Interval Trigger、队列投递和优雅关闭。
...
- 代码计划注册表、Cron/Interval Trigger 与独立 Scheduler；
