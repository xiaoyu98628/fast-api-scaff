...
@pytest.mark.asyncio
async def test_http_login_me_logout_and_public_crud(client: AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_login_reports_missing_user_and_does_not_log_secrets(client: AsyncClient, caplog: pytest.LogCaptureFixture) -> None:
